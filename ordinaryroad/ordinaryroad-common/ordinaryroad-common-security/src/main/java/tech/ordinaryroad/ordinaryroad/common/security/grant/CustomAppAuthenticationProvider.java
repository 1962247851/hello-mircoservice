...
import tech.ordinaryroad.ordinaryroad.common.security.service.OrdinaryroadUserDetailsServiceImpl;
...
public class CustomAppAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		UserDetails userDetails = ((OrdinaryroadUserDetailsServiceImpl) userDetailsService).loadUserByPhone(phone);
