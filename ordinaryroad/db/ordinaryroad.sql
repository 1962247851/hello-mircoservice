DROP DATABASE IF EXISTS `ordinaryroad`;

CREATE DATABASE  `ordinaryroad` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO `sys_menu` VALUES (9999, '系统官网', NULL, 'https://ordinaryroad4cloud.com/#/', -1, 'icon-guanwangfangwen', NULL, 9, '0', '0', '0', NULL, '2019-01-17 17:05:19', 'admin', '2020-03-11 23:52:57');
COMMIT;
...
CREATE TABLE `sys_user` (
                            ...
                            `uuid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL comment '主键UUID',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'b6bb791b9d754a599e9b414477303c67', 'admin', '$2a$10$RpFJjxYiXdEsAGnWp/8fsOetMuOON96Ntk/Ym2M/RKRyU0GZseaDC', NULL, '17034642999', '', 1, '0', '0', '2018-04-20 07:15:18', '2019-01-31 14:29:07', NULL, NULL);
COMMIT;
