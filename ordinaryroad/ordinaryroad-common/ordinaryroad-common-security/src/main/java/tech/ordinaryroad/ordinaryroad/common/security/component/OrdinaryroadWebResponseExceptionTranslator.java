...
import tech.ordinaryroad.ordinaryroad.common.security.exception.*;
 ...
 */
@Slf4j
public class OrdinaryroadWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new OrdinaryroadAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
