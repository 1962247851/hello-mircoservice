 ...
 */
@Slf4j
public class OrdinaryroadSentinelInvocationHandler implements InvocationHandler {
	...
	OrdinaryroadSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			OrdinaryroadSentinelInvocationHandler other = (OrdinaryroadSentinelInvocationHandler) obj;
