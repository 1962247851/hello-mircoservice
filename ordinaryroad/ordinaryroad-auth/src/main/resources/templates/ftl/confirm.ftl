...
<head>
    ...
    <title>Ordinaryroad 第三方授权</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://ordinaryroad4cloud.com">技术支持</a>
            </p>
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://ordinaryroad4cloud.com">${user.username}</a>
            </p>
        </div>
    </div>
</nav>
...
<footer>
    <p>support by: ordinaryroad4cloud.com</p>
