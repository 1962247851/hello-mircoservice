...
package tech.ordinaryroad.ordinaryroad.common.security.feign;
 ...
 */
@Slf4j
public class OrdinaryroadFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public OrdinaryroadFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
