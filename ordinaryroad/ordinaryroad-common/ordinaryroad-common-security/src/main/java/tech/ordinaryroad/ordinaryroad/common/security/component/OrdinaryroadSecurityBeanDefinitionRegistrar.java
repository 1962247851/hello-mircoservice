 ...
 */
@Slf4j
public class OrdinaryroadSecurityBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
	...
	public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
		...
		beanDefinition.setBeanClass(OrdinaryroadResourceServerConfigurerAdapter.class);
