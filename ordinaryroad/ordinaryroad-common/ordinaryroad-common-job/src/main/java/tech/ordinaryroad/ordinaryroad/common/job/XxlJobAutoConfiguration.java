package tech.ordinaryroad.ordinaryroad.common.job;

import tech.ordinaryroad.ordinaryroad.common.job.properties.XxlExecutorProperties;
import tech.ordinaryroad.ordinaryroad.common.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://ordinaryroadx-xxl:9080/xxl-job-admin"
