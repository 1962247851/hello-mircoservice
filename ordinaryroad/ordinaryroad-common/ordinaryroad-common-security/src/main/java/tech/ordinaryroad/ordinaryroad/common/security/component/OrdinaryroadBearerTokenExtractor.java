 ...
 * @date 2020.05.15
 */
public class OrdinaryroadBearerTokenExtractor extends BearerTokenExtractor {

	private final PathMatcher pathMatcher;

	private final PermitAllUrlProperties urlProperties;

	public OrdinaryroadBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
