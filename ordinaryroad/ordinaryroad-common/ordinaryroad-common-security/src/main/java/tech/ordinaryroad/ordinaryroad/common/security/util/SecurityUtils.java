...
package tech.ordinaryroad.ordinaryroad.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public OrdinaryroadUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof OrdinaryroadUser) {
			return (OrdinaryroadUser) principal;
		}
		return null;
	}
	 ...
	 * 获取用户
	 */
	public OrdinaryroadUser getUser() {
